...
public class ShopLauncher {
    ...
    public static void main(String[] args) {
        ...
        SessionRandomValuesHolder sessionRandomValuesHolder = context.getBean(SessionRandomValuesHolder.class);
        ...
        System.out.println(sessionRandomValuesHolder.getValue1());
        System.out.println(sessionRandomValuesHolder.getValue2());
        System.out.println(sessionRandomValuesHolder.getValue3());
    }
}
